resource "azurerm_eventgrid_system_topic_event_subscription" "event_subscription" {
  ...
  dynamic "webhook_endpoint" {
    ...
    dynamic "advanced_filter" {
      ...
      content {
        ...
        dynamic "number_greater_than" {
          for_each = lookup(var.eventgrid_settings.advanced_filter, "number_greater_than", {}) != {} ? [
            "number_greater_than"
          ] : []
          content {
    ...
    labels                               = var.labels
    advanced_filtering_on_arrays_enabled = var.eventgrid_settings.advanced_filtering_on_arrays_enabled
  }
}